...
class RouteApi(object):
    ...
    def manifest_post(self, **kwargs):  # noqa: E501
        """Manifest Export  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.manifest_post(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.manifest_post_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.manifest_post_with_http_info(**kwargs)  # noqa: E501
            return data

    def manifest_post_with_http_info(self, **kwargs):  # noqa: E501
        """Manifest Export  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.manifest_post_with_http_info(async_req=True)
        >>> result = thread.get()
