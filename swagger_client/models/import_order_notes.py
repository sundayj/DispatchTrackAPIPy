...
class ImportOrderNotes(object):
    ...
    def __init__(self, body=None):  # noqa: E501
        """ImportOrderNotes - a model defined in Swagger"""  # noqa: E501
        self._body = None
    ...
    @property
    def body(self):
        """Gets the body of this ImportOrderNotes.  # noqa: E501


        :return: The body of this ImportOrderNotes.  # noqa: E501
        :rtype: str
        """
        return self._body
    ...
    @body.setter
    def body(self, body):
        """Sets the body of this ImportOrderNotes.


        :param body: The body of this ImportOrderNotes.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ImportOrderNotes, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ImportOrderNotes):
            return False
