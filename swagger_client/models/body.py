...
class Body(object):
    ...
    """
    swagger_types = {
        'service_orders': 'list[ImportOrder]'
    }
    ...
    def __init__(self, service_orders=None):  # noqa: E501
    ...
    def service_orders(self):
        """Gets the service_orders of this Body.  # noqa: E501


        :return: The service_orders of this Body.  # noqa: E501
        :rtype: list[ImportOrder]
        """
        return self._service_orders

    @service_orders.setter
    def service_orders(self, service_orders):
        """Sets the service_orders of this Body.


        :param service_orders: The service_orders of this Body.  # noqa: E501
        :type: list[ImportOrder]
        """
        if service_orders is None:
            raise ValueError("Invalid value for `service_orders`, must not be `None`")  # noqa: E501
