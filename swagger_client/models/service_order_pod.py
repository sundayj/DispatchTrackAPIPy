...
class ServiceOrderPod(object):
    ...
    def __init__(self, url=None):  # noqa: E501
        """ServiceOrderPod - a model defined in Swagger"""  # noqa: E501
        self._url = None
    ...
    @property
    def url(self):
        """Gets the url of this ServiceOrderPod.  # noqa: E501


        :return: The url of this ServiceOrderPod.  # noqa: E501
        :rtype: str
        """
        return self._url
    ...
    @url.setter
    def url(self, url):
        """Sets the url of this ServiceOrderPod.


        :param url: The url of this ServiceOrderPod.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ServiceOrderPod, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ServiceOrderPod):
            return False
